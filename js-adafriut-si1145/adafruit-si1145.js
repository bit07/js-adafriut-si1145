...
(function() {
  ...
  Adafruit_SI1145 = (function() {
    ...
    function Adafruit_SI1145(address) {
    ...
    Adafruit_SI1145.prototype.begin = function() {
      var id;
      id = this._read(SI1145_REG_PARTID);
      if (id !== 0x45) {
        return;
      }
      reset();
      this._send(SI1145_REG_UCOEFF0, 0x29);
      this._send(SI1145_REG_UCOEFF1, 0x89);
      this._send(SI1145_REG_UCOEFF2, 0x02);
      this._send(SI1145_REG_UCOEFF3, 0x00);
      this._sendParam(SI1145_PARAM_CHLIST, SI1145_PARAM_CHLIST_ENUV | SI1145_PARAM_CHLIST_ENALSIR | SI1145_PARAM_CHLIST_ENALSVIS | SI1145_PARAM_CHLIST_ENPS1);
      this._send(SI1145_REG_INTCFG, SI1145_REG_INTCFG_INTOE);
      this._send(SI1145_REG_IRQEN, SI1145_REG_IRQEN_ALSEVERYSAMPLE);
      this._send(SI1145_REG_PSLED21, 0x03);
      this._sendParam(SI1145_PARAM_PS1ADCMUX, SI1145_PARAM_ADCMUX_LARGEIR);
      this._sendParam(SI1145_PARAM_PSLED12SEL, SI1145_PARAM_PSLED12SEL_PS1LED1);
      this._sendParam(SI1145_PARAM_PSADCGAIN, 0);
      this._sendParam(SI1145_PARAM_PSADCOUNTER, SI1145_PARAM_ADCCOUNTER_511CLK);
      this._sendParam(SI1145_PARAM_PSADCMISC, SI1145_PARAM_PSADCMISC_RANGE | SI1145_PARAM_PSADCMISC_PSMODE);
      this._sendParam(SI1145_PARAM_ALSIRADCMUX, SI1145_PARAM_ADCMUX_SMALLIR);
      this._sendParam(SI1145_PARAM_ALSIRADCGAIN, 0);
      this._sendParam(SI1145_PARAM_ALSIRADCOUNTER, SI1145_PARAM_ADCCOUNTER_511CLK);
      this._sendParam(SI1145_PARAM_ALSIRADCMISC, SI1145_PARAM_ALSIRADCMISC_RANGE);
      this._sendParam(SI1145_PARAM_ALSVISADCGAIN, 0);
      this._sendParam(SI1145_PARAM_ALSVISADCOUNTER, SI1145_PARAM_ADCCOUNTER_511CLK);
      this._sendParam(SI1145_PARAM_ALSVISADCMISC, SI1145_PARAM_ALSVISADCMISC_VISRANGE);
      this._send(SI1145_REG_MEASRATE0, 0xFF);
      return this._send(SI1145_REG_COMMAND, SI1145_PSALS_AUTO);
    };

    Adafruit_SI1145.prototype.reset = function() {
      this._send(SI1145_REG_MEASRATE0, 0);
      this._send(SI1145_REG_MEASRATE1, 0);
      this._send(SI1145_REG_IRQEN, 0);
      this._send(SI1145_REG_IRQMODE1, 0);
      this._send(SI1145_REG_IRQMODE2, 0);
      this._send(SI1145_REG_INTCFG, 0);
      this._send(SI1145_REG_IRQSTAT, 0xFF);
      this._send(SI1145_REG_COMMAND, SI1145_RESET);
      delay(10);
      this._send(SI1145_REG_HWKEY, 0x17);
      return delay(10);
    };
